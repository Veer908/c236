...
def genterate_radar_blueprint(blueprint_library):
    radar_blueprint = blueprint_library.filter('sensor.other.radar')[0]
    radar_blueprint.set_attribute('horizantal_fov', str(10))
    radar_blueprint.set_blueprint('vertical_fov', str(10))
    radar_blueprint.set_blueprint('points_per_second', str(15000))
...
#define & Apply semantic_lidar_data function
    def semantic_lidar_data(lidar_data):
        distance_name_data = {}
